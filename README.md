...
[![v9.25.0](https://img.shields.io/badge/version-v9.25.0-brightgreen)](#status)
[![95 tools](https://img.shields.io/badge/tools-95-blue)](#tools)
[![327 tests](https://img.shields.io/badge/tests-327%20passing-success)](#requirements)
...
| **Unit tests** | **327 passing**, 10 integration tests gated on a running UE editor (GUI 10/10, headless 8/10 + 2 explicit skips) |
